$(document).ready(function(){
		$("#item1").click(function(){
			...
			$("#i2").removeClass("fa fa-minus close");
			$("#i2").addClass("fa fa-plus open");
			$("#i3").removeClass("fa fa-minus close");
			$("#i3").addClass("fa fa-plus open");
 		});
		$("#item2").click(function(){
			...
			$("#i1").removeClass("fa fa-minus close");
			$("#i1").addClass("fa fa-plus open");
			$("#i3").removeClass("fa fa-minus close");
			$("#i3").addClass("fa fa-plus open");
		});
